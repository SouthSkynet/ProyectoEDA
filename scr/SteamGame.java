public class SteamGame {
    ...
    private String appId;           // String: coincide con el CSV y la clave de HashTable
    private String name;
    ...
    private double averagePlaytimeForever; // en minutos
    private String developers;
    private String genres;

    public SteamGame(String appId, String name, String releaseDate,
                     double price, int recommendations,
                     int positive, int negative,
                     double averagePlaytimeForever,
    ...
    public double getAveragePlaytimeForever() { return averagePlaytimeForever; }
    public String getDevelopers()             { return developers; }
    public String getGenres()                 { return genres; }

    @Override
    public String toString() {
        return String.format("[%s] %s | $%.2f | Recomendaciones: %d | Géneros: %s",
